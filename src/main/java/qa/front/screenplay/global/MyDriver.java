...
//            options.addArguments("user-data-dir=C:\\Users\\Incluit\\Documents\\seguritech\\web\\profile");
    ...
    private static String getDefaultDownloadFolder(String driver) {
        String downloadFolder = SystemEnvironmentVariables.createEnvironmentVariables().getProperty(driver + ".downloadFolder");
